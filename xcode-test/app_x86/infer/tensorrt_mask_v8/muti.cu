...
void MatMuti(float* dim1,float *dim2,float* result,int dim1size[2],int dim2size[2])
{
    int dx = 400;//1280->320x320 800->200x200;// 102400 的整除数
    ...
    for(int i = 0;i<dim2size[1];i+=dx){
        // cudaMemcpy(index,&i, 1*sizeof(int), cudaMemcpyHostToDevice);
